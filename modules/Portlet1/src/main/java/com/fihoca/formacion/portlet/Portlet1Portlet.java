...
public class Portlet1Portlet extends MVCPortlet {
	...
	public void serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		try(OutputStreamWriter osw = new OutputStreamWriter(resourceResponse.getPortletOutputStream()); CSVPrinter printer = new CSVPrinter(osw, CSVFormat.DEFAULT.withHeader("num", "cliente", "importe"))){
	...
	public void render(RenderRequest renderRequest, RenderResponse renderResponse)
		...
		if((jspPage = renderRequest.getParameter("jspPage")) != null) {
			...
			if (jspPage.equals("/edit.jsp")) {
				...
				Hashtable<String, String> FACTURA= new Hashtable<String,String>(); ;
				FACTURA.put("num", num);
	...
	public void editarFactura(ActionRequest actionRequest, ActionResponse actionResponse)
			throws IOException, PortletException{
			...
			this.FACTURAS = FACTURAS.stream().map(f -> {
				System.out.println(num);
				System.out.println(f.get("num"));
				System.out.println(f.get("num").equals(num));
